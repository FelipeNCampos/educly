...
export const CandyCrushPath = ({ phases, isPhaseUnlocked, isPhaseCompleted, onPhaseClick }: CandyCrushPathProps) => {
  ...
  const getStatusColor = (status: string, isNextStep: boolean) => {
    if (status === "locked") return "#334155"; // Slate 700 sólido
    if (isNextStep) return "#8b5cf6";          // Violet 500 sólido
    return "#10b981";                         // Emerald 500 sólido (Verde do seu print)
  };
              ...
              return (
                ...
                >
                  ...
                  <path
                    d="M -38, 0 A 38,38 0 1,0 38,0 A 38,38 0 1,0 -38,0"
                    style={{ 
                      fill: color,           // Cor sólida
                      fillOpacity: 1,        // Opacidade forçada em 100%
