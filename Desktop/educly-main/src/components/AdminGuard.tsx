  ...
  useEffect(() => {
    const checkAdminAccess = async () => {
      try {
        ...
        // Double verification: email + admin role in database
        const isEmailMatch = user.email?.toLowerCase() === MASTER_ADMIN_EMAIL.toLowerCase();
        ...
        setIsAuthorized(isEmailMatch && isAdmin === true);
        setIsLoading(false);
      } catch (error) {
