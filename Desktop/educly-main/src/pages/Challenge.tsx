                        ...
                        >
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              isLocked
                                ? "bg-[#e2e8f0] dark:bg-[#1e293b] border-[#cbd5e1] dark:border-[#334155] cursor-not-allowed opacity-50"
                                : isCompleted
                                  ? "bg-[#22c55e] border-[#16a34a] text-white shadow-[0_0_15px_rgba(34,197,94,0.4)]"
                                  : isCurrent
                                    ? "bg-[#6366f1] border-[#4f46e5] text-white shadow-lg ring-4 ring-indigo-500/20"
                                    : "bg-white dark:bg-[#0f172a] border-[#e2e8f0] dark:border-[#1e293b] hover:border-primary/50"
                            )}
                          >
                          ...
                          <div className={cn(
                            "mt-3 w-32 text-center bg-white dark:bg-[#1e293b] border border-border px-2 py-2 rounded-xl shadow-md transition-all",
