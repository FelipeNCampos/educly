-- Atualizar função process_pending_billing_events para normalizar emails removendo pontos finais
...
BEGIN
  ...
  LOOP
    ...
    -- Mark event as processed and normalize the stored email
    ...
    SET processed = true, 
        ...
        user_id = p_user_id,
        is_premium_set = true,
        email = v_normalized_email  -- Also normalize stored email
    WHERE id = v_event.id;
  END LOOP;
END;
$$;