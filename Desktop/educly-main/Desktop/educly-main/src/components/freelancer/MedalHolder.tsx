...
<<<<<<< HEAD
// Cores sólidas e fundos suaves idênticos ao Profile
...
<<<<<<< HEAD
  bronze: "ring-1 ring-amber-600/30",
  silver: "ring-1 ring-slate-400/30",
  gold: "ring-1 ring-yellow-500/30",
  platinum: "ring-1 ring-purple-500/30",
=======
...
<<<<<<< HEAD
      <TooltipProvider delayDuration={0}>
        <div className="grid grid-cols-5 sm:grid-cols-8 md:grid-cols-9 gap-3">
=======
...
<<<<<<< HEAD
                  <div className="flex flex-col items-center">
                    <div className={cn(
                      ...
                      medal.isEarned 
                        ? cn(colors.bg, colors.border, "shadow-sm scale-105") 
                        : "bg-muted border-border grayscale opacity-30"
                    )}>
                      {medal.isEarned ? (
                ...
                <TooltipContent className="font-bold text-[11px]">
                  <p>{medal.name}</p>
=======
                  <button
                    className={cn(
