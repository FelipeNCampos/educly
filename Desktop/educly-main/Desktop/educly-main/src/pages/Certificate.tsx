...
const Certificate = () => {
  ...
  useEffect(() => {
    ...
    ctx.fillText(t('certificate.title'), width / 2, 250);
    ...
    ctx.fillText(certificate.user_full_name || t('dashboard.student'), width / 2, 410);
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-success/10 safe-area-inset">
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <header className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-xl font-bold text-foreground">{t('certificate.myCertificate')}</h1>
        </header>
