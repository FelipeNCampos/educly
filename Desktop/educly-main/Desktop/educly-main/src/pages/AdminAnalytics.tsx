...
import { UserBugsTable } from "@/components/admin/UserBugsTable"; 
...
const AdminAnalyticsContent = () => {
  ...
  const refreshAll = () => {
    // Invalida todas as queries para atualizar o dashboard
    ...
    queryClient.invalidateQueries({ queryKey: ["admin-user-bugs"] }); 
  };
            ...
            <div className="flex items-center gap-4 text-left">
              ...
              <div className="flex items-center gap-3 text-left">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-muted-foreground">Métricas e bugs em tempo real</p>
                </div>
              </div>
            </div>
            <Button variant="outline" size="sm" onClick={refreshAll} className="rounded-xl border-border/50 hover:bg-slate-50">
      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <Tabs defaultValue="billing" className="w-full">
          <TabsList className="grid w-full grid-cols-5 h-12 p-1 bg-muted/50 rounded-xl">
            <TabsTrigger value="billing">📋 Billing Logs</TabsTrigger>
            <TabsTrigger value="cancellations">⚠️ Cancelamentos</TabsTrigger>
            <TabsTrigger value="streaks">🏆 Top Streaks</TabsTrigger>
            <TabsTrigger value="premium">👑 Premium</TabsTrigger>
            <TabsTrigger value="bugs" className="text-red-500 font-bold data-[state=active]:bg-white">🪲 Bugs</TabsTrigger>
          </TabsList>

          <div className="mt-4 text-left">
            <TabsContent value="billing" className="m-0"><BillingLogsTable /></TabsContent>
            <TabsContent value="cancellations" className="m-0"><CancellationsTable /></TabsContent>
            <TabsContent value="streaks" className="m-0"><TopStreaksTable /></TabsContent>
            <TabsContent value="premium" className="m-0"><PremiumUsersTable /></TabsContent>
            <TabsContent value="bugs" className="m-0"><UserBugsTable /></TabsContent>
          </div>
        </Tabs>
