...
const productConfig = {
  freelancer: {
    ...
    checkoutUrl: "https://hotmart.com/checkout/freelancer-placeholder",
    features: [
      "freelancer.feature1",
      "freelancer.feature2",
      "freelancer.feature3",
  ...
  ai_hub: {
    ...
    checkoutUrl: "https://hotmart.com/checkout/ai-hub-placeholder",
    features: [
      "ai_hub.feature1",
      "ai_hub.feature2",
      "ai_hub.feature3",
        ...
        <Card className="overflow-hidden border-0 shadow-2xl">
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <Button
              ...
              className={`w-full py-6 text-lg font-semibold bg-gradient-to-r ${config.gradient} hover:opacity-90 transition-opacity`}
            >
