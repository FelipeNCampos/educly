...
<<<<<<< HEAD
// colorMap unificado (Idêntico ao Profile)
...
>>>>>>> a3dfd408a50ed8114d7cfaf77ffa9c5c1dce291d
};
...
<<<<<<< HEAD
                      ...
                      "border-2",
                      medal.isEarned
                        ? cn(colors.bg, colors.border, "shadow-sm scale-105 cursor-pointer")
                        : "bg-muted border-border opacity-30 grayscale cursor-default"
                    )}
                  >
                    {medal.isEarned ? (
                  ...
                  <span className={cn(
                    "text-[10px] text-center font-bold max-w-[80px] truncate uppercase tracking-tighter",
                    medal.isEarned ? "text-foreground" : "text-muted-foreground/50"
=======
...
<<<<<<< HEAD
              <TooltipContent side="top" className="max-w-xs font-bold text-[11px]">
                <div className="text-center">
                  <p>{medal.name}</p>
                  <p className="text-[10px] font-medium opacity-70">{medal.description}</p>
=======
              <TooltipContent
                side="top"
                className={cn(
...
>>>>>>> a3dfd408a50ed8114d7cfaf77ffa9c5c1dce291d
  ...
  return (
<<<<<<< HEAD
    <div className="min-h-screen bg-background safe-area-inset transition-colors duration-300">
